                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">Type tube</label>
                                                <select class="form-control" id="exampleFormControlSelect1">
                                                    <option>-</option>
                                                    <option>Congelé</option>
                                                </select>
                                            </div>
                                            <div class="row">
                                ...
                                <form>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="number" class="form-control" id="taille" placeholder="160cm">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="inputZip">Poids</label>
                                            <input type="number" class="form-control" id="poids" placeholder="56Kg">
                                        </div>
