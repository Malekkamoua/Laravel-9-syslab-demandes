...
<head>
    ...
    <!-- Favicon Icon -->
    <link rel="icon" href="{{ asset('style') }}/img/favicon.png" />
    <!-- Stylesheets -->
...
<body>
            ...
            <div class="container">
                <div class="st-main-header-in">
                    <div class="st-main-header-left">
                        <a class="st-site-branding" href="index.html"><img src="{{ asset('style') }}/img/logo.png"
                                alt="Nischinto"></a>
                    </div>
    ...
    <div class="st-content">
        ...
        <!-- Start Hero Seciton -->
        <div class="st-hero st-style1 st-dynamic-bg st-bg st-fixed-bg" data-src="{{ asset('style') }}/img/hero-bg3.jpg">
            <div class="container">
                <div class="st-hero-text st-style1 text-center">
                    ...
                    <div class="st-hero-subtitle">The art of medicine consists in amusing the patient while nature cures
                        the
                        disease. <br>
                    ...
                    <div class="st-hero-btn-group">
                        ...
                        <a href="#about" class="st-btn st-style1 st-size-medium st-color3 st-smooth-move">About Us</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <div class="st-seperator">
                        ...
                        <div class="st-seperator-center"><img src="{{ asset('style') }}/img/icons/4.png" alt="icon">
                        </div>
                            ...
                            <div class="st-vertical-middle-in">
                                <div class="st-text-block st-style1">
                                    ...
                                    <div class="st-text-block-avatar">
                                        <div class="st-avatar-img"><img src="{{ asset('style') }}/img/avatar1.png"
                                                alt="avatar"></div>
                    ...
                    <div class="tab-content">
                        <div id="Crutches" class="st-tab active">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img src="{{ asset('style') }}/img/crutches.png"
                                                alt="service"></div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                        ...
                        <div id="X-ray" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img src="{{ asset('style') }}/img/xray.png"
                                                alt="service"></div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                        ...
                        <div id="Pulmonary" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img src="{{ asset('style') }}/img/pulmonary.png"
                                                alt="service"></div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                        ...
                        <div id="Cardiology" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img src="{{ asset('style') }}/img/cardiology.png"
                                                alt="service"></div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                        ...
                        <div id="DentalCare" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img src="{{ asset('style') }}/img/dental-care.png"
                                                alt="service"></div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                        ...
                        <div id="Neurology" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img src="{{ asset('style') }}/img/neurology.png"
                                                alt="service"></div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
        ...
        <section id="appointment" class="st-shape-wrap st-gray-bg">
            <div class="st-shape4">
                <img src="{{ asset('style') }}/img/shape/section_shape.png" alt="shape1">
            </div>
            <div class="st-shape6">
                <img src="{{ asset('style') }}/img/shape/contact-shape3.svg" alt="shape3">
            </div>
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <form method="POST" action="{{ asset('style') }}/php/appointment.php"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        ...
                                        <input type="text" id="uemail" name="uemail" placeholder="example@gmail.com"
                                            required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                    ...
                    <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                        ...
                        <div class="slick-wrapper">
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="{{ asset('style') }}/img/member1.jpg" alt="" class="st-zoom-in">
                                        <a class="st-doctor-link" href="doctor-profile.html"><i
                                                class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                                            <img src="{{ asset('style') }}/img/shape/member-shape.svg" alt="shape"
                            ...
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="{{ asset('style') }}/img/member2.jpg" alt="member2"
                                            class="st-zoom-in">
                                        <a class="st-doctor-link" href="doctor-profile.html"><i
                                                class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                            ...
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="{{ asset('style') }}/img/member3.jpg" alt="member3"
                                            class="st-zoom-in">
                                        <a class="st-doctor-link" href="doctor-profile.html"><i
                                                class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                            ...
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="{{ asset('style') }}/img/member4.jpg" alt="member4"
                                            class="st-zoom-in">
                                        <a class="st-doctor-link" href="doctor-profile.html"><i
                                                class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                ...
                <div class="st-portfolio-wrapper">
                    ...
                    <div class="st-isotop st-style1 st-port-col-3 st-has-gutter st-lightgallery">
                        ...
                        <div class="st-isotop-item cardiology urology">
                            <a href="{{ asset('style') }}/img/project1_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img src="{{ asset('style') }}/img/project1.jpg"
                                        alt="project1"></div>
                        ...
                        <div class="st-isotop-item cardiology neurology">
                            <a href="{{ asset('style') }}/img/project2_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img src="{{ asset('style') }}/img/project2.jpg"
                                        alt="project2"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->
                        ...
                        <div class="st-isotop-item urology pulmonary">
                            <a href="{{ asset('style') }}/img/project3_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img src="{{ asset('style') }}/img/project3.jpg"
                                        alt="project3"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->
                        ...
                        <div class="st-isotop-item neurology traumatology">
                            <a href="{{ asset('style') }}/img/project4_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img src="{{ asset('style') }}/img/project4.jpg"
                                        alt="project4"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->
                        ...
                        <div class="st-isotop-item cardiology pulmonary">
                            <a href="{{ asset('style') }}/img/project5_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img src="{{ asset('style') }}/img/project5.jpg"
                                        alt="project5"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->
                        ...
                        <div class="st-isotop-item neurology traumatology">
                            <a href="{{ asset('style') }}/img/project6_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img src="{{ asset('style') }}/img/project6.jpg"
                                        alt="project6"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->
                        ...
                        <div class="st-isotop-item urology pulmonary traumatology">
                            <a href="{{ asset('style') }}/img/project7_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img src="{{ asset('style') }}/img/project7.jpg"
                                        alt="project6"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->
        ...
        <section class="st-before-after-section st-dynamic-bg st-bg"
            data-src="{{ asset('style') }}/img/before-after-bg.jpg">
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <div class="st-before-after-in">
                        <div class="st-before-after">
                            <div class="st-after st-single-slide st-dynamic-bg"
                                data-src="{{ asset('style') }}/img/after.jpg"></div>
                            <div class="st-before st-single-slide st-dynamic-bg"
                                data-src="{{ asset('style') }}/img/before.jpg"></div>
                        ...
                        <div class="slick-wrapper">
                            <div class="slick-slide-in">
                                <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                    ...
                                    <div class="st-testimonial-info">
                                        <div class="st-testimonial-img"><img src="{{ asset('style') }}/img/avatar2.png"
                                                alt="avatar1"></div>
                            ...
                            <div class="slick-slide-in">
                                <div class="st-testimonial st-style1">
                                    <div class="st-testimonial-info">
                                        <div class="st-testimonial-img"><img src="{{ asset('style') }}/img/avatar3.png"
                                                alt="avatar2"></div>
                                        <div class="st-testimonial-meta">
                            ...
                            <div class="slick-slide-in">
                                <div class="st-testimonial st-style1 wow fadeInRight" data-wow-duration="0.8s"
                                    data-wow-delay="0.2s">
                                    <div class="st-testimonial-info">
                                        <div class="st-testimonial-img"><img src="{{ asset('style') }}/img/avatar4.png"
                                                alt="avatar3"></div>
                                        <div class="st-testimonial-meta">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="st-video-block st-style1 st-zoom">
                            <div class="st-video-block-img st-zoom-in st-dynamic-bg"
                                data-src="{{ asset('style') }}/img/video-block-img.jpg"></div>
                            ...
                            <div class="slick-slide-in">
                                <div class="st-pricing-table st-style1">
                                    <div class="st-pricing-head">
                                        ...
                                        <img src="{{ asset('style') }}/img/shape/price-shape.svg" alt="shape"
                                    ...
                                    <div class="st-pricing-feature">
                                        ...
                                        <div class="st-pricing-btn">
                                            <a href="#" class="st-btn st-style2 st-color1 st-size-medium">Contact
                                                Now</a>
                                        </div>
                                        <div class="st-height-b30 st-height-lg-b30"></div>
                                    </div>
        ...
        <section class="st-faq-wrap st-shape-wrap">
            <div class="st-shape5">
                <img src="{{ asset('style') }}/img/shape/faq-bg.svg" alt="shape1">
            </div>
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="row">
                        ...
                        <div class="st-vertical-middle">
                            <div class="st-vertical-middle-in">
                                <div class="st-faq-img">
                                    <img src="{{ asset('style') }}/img/faq-img.png" alt="Faq Image">
                                </div>
                            </div>
                        </div>
                        <div class="st-height-b0 st-height-lg-b30"></div>
                        ...
                        <div class="st-accordian-wrap">
                            <div class="st-accordian active ">
                                ...
                                <div class="st-accordian-body">Lorem Ipsum is simply dummy text of the printing and
                                    typesetting
                                    industry. Lorem Ipsum has been the industry's standard dummy text ever since when an
                                    unknown printer
        ...
        <section class="st-news-letter-section st-dynamic-bg st-bg"
            data-src="{{ asset('style') }}/img/news-letter-bg.png">
            <div class="container">
                <div class="st-section-heading st-style1">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="st-post st-style3">
                            <a href="blog-details-right-sidebar.html" class="st-post-thumb st-link-hover-wrap st-zoom">
                                <img class="st-zoom-in" src="{{ asset('style') }}/img/blog1.jpg" alt="blog1">
                                <span class="st-link-hover"><i class="fas fa-link"></i></span>
                            </a>
                            <div class="st-post-info">
                                <h2 class="st-post-title"><a href="blog-details-right-sidebar.html">Working in emergency
                                        medicine</a>
                                </h2>
                                ...
                                <div class="st-post-text">Lorem Ipsum is simply dummy text of the print ing and
                    ...
                    <div class="col-lg-4">
                        <div class="st-post st-style3">
                            <a href="blog-details-right-sidebar.html" class="st-post-thumb st-link-hover-wrap st-zoom">
                                <img class="st-zoom-in" src="{{ asset('style') }}/img/blog2.jpg" alt="blog1">
                                <span class="st-link-hover"><i class="fas fa-link"></i></span>
                            </a>
                            <div class="st-post-info">
                                <h2 class="st-post-title"><a href="blog-details-right-sidebar.html">Individual treatment
                                        &
                                        assistance</a></h2>
                                <div class="st-post-meta">
                    ...
                    <div class="col-lg-4">
                        <div class="st-post st-style3">
                            <a href="blog-details-right-sidebar.html" class="st-post-thumb st-link-hover-wrap st-zoom">
                                <img class="st-zoom-in" src="{{ asset('style') }}/img/blog3.jpg" alt="blog1">
                                <span class="st-link-hover"><i class="fas fa-link"></i></span>
                            </a>
                            <div class="st-post-info">
                                <h2 class="st-post-title"><a href="blog-details-right-sidebar.html">Child’s first
                                        hospital visit</a>
                                </h2>
                                <div class="st-post-meta">
                        ...
                        <div class="slick-wrapper">
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-orange-box">
                                    <img src="{{ asset('style') }}/img/client1.png" alt="client1">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-blue-box">
                                    <img src="{{ asset('style') }}/img/client2.png" alt="client2">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-red-box">
                                    <img src="{{ asset('style') }}/img/client3.png" alt="client3">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-green-box">
                                    <img src="{{ asset('style') }}/img/client4.png" alt="client4">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-dip-blue-box">
                                    <img src="{{ asset('style') }}/img/client5.png" alt="client5">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-orange-box">
        ...
        <section class="st-shape-wrap" id="contact">
            <div class="st-shape1"><img src="{{ asset('style') }}/img/shape/contact-shape1.svg" alt="shape1"></div>
            <div class="st-shape2"><img src="{{ asset('style') }}/img/shape/contact-shape2.svg" alt="shape2"></div>
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div id="st-alert"></div>
                        <form action="{{ asset('style') }}/php/mail.php" class="row st-contact-form st-type1"
                    ...
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            <div class="st-text-field">
                                <img src="{{ asset('style') }}/img/footer-logo.png" alt="Nischinto"
