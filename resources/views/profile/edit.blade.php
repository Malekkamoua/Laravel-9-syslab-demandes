                ...
                <div class="card-body">
                    <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('code_labo') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-name">{{ __('Laboratoire') }}</label>
                                <input type="text" name="code_labo" id="input-name"
                                    class="form-control form-control-alternative{{ $errors->has('code_labo') ? ' is-invalid' : '' }}"
                                    placeholder="{{ __('code_labo') }}"
                                    value="{{ old('code_labo', auth()->user()->code_labo) }}" required autofocus>

                                @if ($errors->has('code_labo'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('code_labo') }}</strong>
                                </span>
                                @endif
                            </div>
                            @endif
